...
{
     return (
          <header className="p-3 w-full sticky top-0 z-50 bg-linear-to-r from-neutral-950 from-80% to-[#815600] hidden lg:flex">
               <div className="w-full flex justify-between items-center text-base xl:px-6 font-semibold">
