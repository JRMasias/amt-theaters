...
{
     return (
          <footer className="flex flex-col justify-center items-center mt-10 bg-neutral-800">
               ...
               <div className="w-full lg:w-4/5 lg:m-auto p-10 flex flex-col lg:flex-row justify-evenly items-start">
                    { links.map((link, idx) =>
                    {
                         return <div className="flex flex-col items-center lg:items-start w-full pb-10 lg:pb-0" key={ idx }>
                              { link.map((item, id) =>
                              {
                                   return <ul className="text-white flex flex-col" key={ id }>
